...
const sections: { heading: string; body: string | string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "（5）登録スタッフ（駆けつけ・施設管理）のご登録時",
      "・お名前、生年月日、ご住所、連絡先、LINE ID、本人確認書類、報酬の振込口座、対応できるエリア・時間帯等",
      "（6）当ウェブサイトのご利用時（自動的に取得される情報）",
  ...
  },
  {
    ...
    body: [
      ...
      "・登録スタッフへのお仕事の依頼・連絡、業務委託契約の締結・履行、報酬の支払い、本人確認のため（登録スタッフの場合）",
      "・上記各号に付随する業務上の連絡",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "・LINE公式アカウント（LINEヤフー株式会社）：登録スタッフとの連絡・お仕事の依頼",
    ],
  },
  {

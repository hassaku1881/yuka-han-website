...
const sections: { heading: string; body: string | string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "（4）採用へのご応募時",
      "・お名前、連絡先、履歴書等の応募書類に記載された事項、選考の過程でお伺いした事項",
      "（5）当ウェブサイトのご利用時（自動的に取得される情報）",
  ...
  },
  {
    ...
    body: [
      ...
      "・採用へのご応募に関する選考、選考に関するご連絡および採否の通知のため（採用応募者の場合）",
      "・上記各号に付随する業務上の連絡",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "・Google Workspace（Google LLC、米国）：メールの送受信、応募書類等の保管",
      "・Airワーク 採用管理（株式会社リクルート）：一部の求人の応募受付・応募者管理",
    ],
  },
  {
  ...
  {
    heading: "10. 安全管理措置",
    body: "当社は、取得した個人情報の漏洩・滅失・毀損の防止その他の安全管理のため、アクセス権限の管理、通信の暗号化、取扱状況の把握等、必要かつ適切な安全管理措置を講じます。また、宿泊者名簿およびパスポートの写しは、旅館業法に基づき3年間保管し、保管期間経過後に適切に削除します。これらの情報は、法令に基づく行政機関からの求めがある場合を除き、第三者に提供することはありません。採用応募者の個人情報は採用選考以外の目的には使用せず、選考終了後、保管の必要がなくなった時点で速やかに破棄・削除します。ご本人から削除のお求めがあった場合も同様に対応します。",
  },
  {

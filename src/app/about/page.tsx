            ...
            {[
              {
                ...
                bio: "製造業にて製品の研究開発を経て、新製品のブランディングおよびマーケティングを担当。学生時代にカナダ・マギル大学への留学、ドイツ・スイスの多国籍企業でのビジネスインターンシップを経験。これまでに全国47都道府県、世界70カ国以上を旅し、世界中のAirbnbにゲストとして滞在してきた視点を、空間設計とゲスト体験に活かす。施設のブランディング、ゲスト体験設計、QA（品質維持）を担当。",

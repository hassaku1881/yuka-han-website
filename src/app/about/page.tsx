      ...
      <section style={{ background: "var(--color-white)", padding: "6rem 8%" }}>
        <div style={{ maxWidth: "780px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.7rem" }}>
            ...
            <p style={{ fontSize: "1rem", lineHeight: 2.2, color: "var(--color-text-light)" }}>
              滞在のしかたはいつも「暮らすような旅」だった。1週間ひとつの場所にとどまって、近所のスーパーで食材を買い、その土地の音楽を聴く。観光地を駆け抜けるのではなく、空気を吸い込むように街と関わる。そういう滞在のなかでしか見えてこないものを、私たちはたくさん集めてきた。
            </p>
            <p style={{ fontSize: "1rem", lineHeight: 2.2, color: "var(--color-text-light)" }}>
            ...
            {[
              {
                ...
                bio: "製造業にて研究開発を経て、マーケティング・ブランディングおよび事業企画を担当。学生時代にカナダ・マギル大学への留学、ドイツの研究所・スイスの多国籍企業でのインターンシップを経験。これまでに全国47都道府県、世界70カ国以上を旅し、世界中のAirbnbにゲストとして滞在してきた視点を、空間設計とゲスト体験に活かす。施設のブランディング、ゲスト体験設計、QA（品質維持）を担当。",

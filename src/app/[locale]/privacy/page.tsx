...
> = {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "(3) Automatically, when you use this website",
      ...
      },
      {
        ...
        body: "The Company takes necessary and appropriate security measures—such as access-rights management, encryption of communications, and monitoring of handling status—to prevent the leakage, loss, or damage of the personal information it collects.",
      },
      {
  ...
  "zh-TW": {
    ...
    sections: [
      ...
      {
        heading: "10. 安全管理措施",
        body: "本公司為防止所取得個人資訊的外洩、滅失或毀損等，採取存取權限管理、通訊加密、掌握處理狀況等必要且適當的安全管理措施。",
      },
      {

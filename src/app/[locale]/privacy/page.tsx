    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "(5) When you register as on-call property support staff",
          "・Name, date of birth, address, contact details, LINE ID, identification documents, bank account for payment, available areas and hours, etc.",
          "(6) Automatically, when you use this website",
      ...
      },
      {
        ...
        body: [
          ...
          "・Offering and communicating about jobs, entering into and performing service contracts, paying fees, and verifying identity (for registered staff)",
      ...
      },
      {
        ...
        body: [
          ...
          "・LINE Official Account (LY Corporation, Japan): communicating with and offering jobs to registered staff",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "（5）登錄為待命支援人員（緊急到場・設施管理）時",
          "・姓名、出生年月日、地址、聯絡方式、LINE ID、身分證明文件、報酬匯款帳戶、可對應的區域與時段等",
          "（6）使用本網站時（自動取得的資訊）",
      ...
      },
      {
        ...
        body: [
          ...
          "・對登錄人員委託工作與聯絡、業務委託契約之締結與履行、報酬支付及身分確認（限登錄人員）",
          "・上述各項附帶的業務聯絡",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          "・LINE官方帳號（LY Corporation，日本）：與登錄人員聯絡及委託工作",
        ],
      },
      {

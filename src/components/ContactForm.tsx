...
const T = {
  ja: {
    ...
    typeSystem: "運営支援システムについて（Check in / S）",
    typeOther: "その他",
  ...
  en: {
    ...
    typeSystem: "About our operations support systems (Check in / S)",
    typeOther: "Other",
  ...
  "zh-TW": {
    ...
    typeMedia: "媒體採訪・刊載邀約",
    typeNeighbor: "周邊住民聯絡",
    typeSystem: "營運支援系統諮詢（Check in / S）",
    typeOther: "其他",
  ...
  typeGuest: string; typeOperations: string; typeMedia: string; typeNeighbor: string; typeSystem: string; typeOther: string;
